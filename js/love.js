...
$(function() {
    var y = getUrlParam("y")
      , m = getUrlParam("m")
      , love = getUrlParam("love")
      , bgmMusic = getUrlParam("bgmMusic");
...
$(function() {
    ...
    $("#write-submit").click(function() {
        ...
        $("#write-post").click(function() {
            ...
            $("#write-url").html('\u60a8\u7684\u8868\u767d\u94fe\u63a5\u662f\uff1a<a href="' + getUrl() + '" target="_blank">' + "http://aijava.cn/demo/love/2014/?y=" + $("#text-75").text() + "&m=" + $("#text-76").text() + "&love=" + $("#text-77").text() + "</a>").fadeIn();
...
function bd_share() {
    ...
    with (sharedesc = $("#text-1").text() + $("#text-2").text() + $("#text-3").text() + $("#text-4").text() + $("#text-5").text() + $("#text-6").text() + $("#text-7").text() + $("#text-8").text() + "......",
    ...
    document)
        0[(getElementsByTagName("head")[0] || body).appendChild(createElement("script")).src = "http://bdimg.share.baidu.com/static/api/js/share.js?v=86326610.js?cdnversion=" + ~(-new Date / 36e5)]
}
